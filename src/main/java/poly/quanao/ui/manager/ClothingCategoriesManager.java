 ...
 * @author Admin
 */
public class ClothingCategoriesManager extends javax.swing.JFrame {

    /**
     * Creates new form Product
     */
    public ClothingCategoriesManager() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClothingCategoriesManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClothingCategoriesManager().setVisible(true);
            }
        });
    }
